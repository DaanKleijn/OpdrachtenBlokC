...
collection = ses.get_collection(
    database=ses.get_database(client=ses.get_client(host="Localhost", port=27017), database_name="opisop"),
    collection_name="products")
collection_data = read.get_collection_information(collection=collection,
                                                  labels=["_id", "name", ["price", "selling_price"]])
