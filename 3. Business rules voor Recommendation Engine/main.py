...
print(
    f"The product with the highest price difference from {random_product[0][1]} (with a price of €{round((random_product[0][2] / 100), 2)}) is {price_difference_highest_product[1]} (with a price of €{round((price_difference_highest_product[2] / 100), 2)})\nThis results in a difference of €{round((abs(price_difference_highest_product[2] - random_product[0][2]) / 100), 2)}")
#####################################################################################################################################